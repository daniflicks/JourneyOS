...
export default function Day3Reflection1({ answers, onChange, onContinue }) {
  ...
  return (
    <div className={styles.mainContent}>
      ...
      <div>
        <h2 className={styles.formLabel}>When I separate what actually happened from what my mind adds, I notice:</h2>
        <textarea
