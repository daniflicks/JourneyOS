...
export default function Day3Main15({
  answers,
  onChange,
  onContinue,
  aiResponse,
  ...
  useEffect(() => {
    ...
    if (lessonsLearned.length > 50 && lessonsLearned !== answers.day3LessonsReframingAnalysis) {
      onChange('day3LessonsReframingAnalysis', lessonsLearned);
    }
  }, [
    answers.day3LessonsFromFirstMemory,
    answers.day3LessonsFromMostPainfulMemory,
    answers.lessonsFromDay3MostRecentMemory,
    answers.day3LessonsReframingAnalysis,
    onChange,
  ]);
