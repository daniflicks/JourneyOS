...
export default function Day5Complete() {
  const { day } = useParams();
    ...
    <div className={styles.mainContent}>
      ...
      <div className={styles.completionHeader}>
        <div className={styles.confettiContainer}>
          ...
          <p className={styles.subtitleBloom}>You&rsquo;ve broken invisible rules and crafted new truths.</p>
        </div>
      </div>
      ...
      <div className={styles.contentAreaWrapper}>
        ...
        <div className={styles.achievementCardWarm}>
          ...
          {[
            'Identified your top limiting beliefs',
            'Selected one belief to transform',
            'Mapped its triggers, costs, and hidden payoffs',
            'Discovered empowering exceptions to the belief',
            'Crafted a balanced reframe and tiny test',
          ].map((text, idx) => (
        ...
        <div className={styles.quoteCardWarm}>
          ...
          <p className={styles.quoteTextWarm}>
            Invisible rules lose power when you question them. Keep choosing gentler truths that move you forward.
          </p>
        </div>
        ...
        <div className={styles.previewCardWarm}>
          ...
          <p className={styles.previewDescriptionWarm}>
            Tomorrow, you&rsquo;ll build momentum by acting on your new truth and gathering real-world evidence.
          </p>
        </div>
        ...
        <div className={styles.footerWarm}>
          ...
          <p className={styles.supportTextWarm}>Remember: Your Emergency Support Box is always available between sessions.</p>
        </div>
      </div>
    </div>
  );
