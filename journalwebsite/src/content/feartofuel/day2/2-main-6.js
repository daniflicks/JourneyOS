...
export default function Day2Main6({
  answers,
  onContinue,
  aiResponse,
  aiLoading,
  ...
  const careerFailureAge = answers.careerFailureAge || '';
    ...
    <div className={styles.mainContent}>
      ...
      <div className={styles.calloutBox}>
        <div className="whitespace-pre-wrap">
          ...
          <p>{careerFailureStory || 'No story provided.'}</p>
          <strong>Age:</strong> {careerFailureAge || 'Not specified'}
        </div>
      </div>
